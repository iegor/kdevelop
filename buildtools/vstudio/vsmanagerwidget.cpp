...
//   m_actionAddMethod = new KAction( i18n("Add Method..."), KShortcut(), this, SLOT(slotAddMethod()), m_part->actionCollection(), "classview_add_method" );
//   m_actionAddMethod->setWhatsThis(i18n("<b>Add method</b><p>Calls the <b>New Method</b> wizard."));

//   m_actionAddAttribute = new KAction( i18n("Add Attribute..."), KShortcut(), this, SLOT(slotAddAttribute()), m_part->actionCollection(), "classview_add_attribute" );
//   m_actionAddAttribute->setWhatsThis(i18n("<b>Add attribute</b><p>Calls the <b>New Attribute</b> wizard."));

//   m_actionOpenDeclaration = new KAction( i18n("Open Declaration"), KShortcut(), this, SLOT(slotOpenDeclaration()), m_part->actionCollection(), "classview_open_declaration" );
...
void VSManagerWidget::openSolution(const QString &sln_path) {
}

void VSManagerWidget::openProject(const QString &prj_path) {
}

void VSManagerWidget::unloadProject(const QString &prj_path) {
}
...
void VSManagerWidget::setViewMode( int mode ) {
  m_actionViewMode->setCurrentItem( mode );
}

int VSManagerWidget::viewMode( ) const
{
...
// void VSManagerWidget::slotAddAttribute( )
// {
//   if ( !selectedItem() ) return;
//
...
// void VSManagerWidget::slotOpenDeclaration( )
// {
//   if ( !selectedItem() ) return;
//
...
// void VSManagerWidget::slotOpenImplementation( )
// {
//   if ( !selectedItem() ) return;
//
...
// void VSManagerWidget::slotCreateAccessMethods( )
// {
//   if ( !selectedItem() ) return;
//
