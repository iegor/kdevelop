...
class VStudioPart : public Extensions::KDevCodeBrowserFrontend
{
    Q_OBJECT
public:
    VStudioPart(QObject *parent, const char *name, const QStringList &);
    virtual ~VStudioPart();
    ...
    inline VSSlnExplorerWidget* widget() {
        return &( *m_widget );
    }
...
private:
    ...
    QGuardedPtr<VSSlnExplorerWidget> m_widget;
