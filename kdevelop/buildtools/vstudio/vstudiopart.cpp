    ...
    m_activeDocument(0), m_activeView(0), m_activeSelection(0), m_activeEditor(0), m_activeViewCursor(0), m_hierarchyDlg(0)
{
    ...
    QWhatsThis::add(m_widget, i18n("<b>Solution Explorer</b><p>"
            "Shows all projects and files in ms vs solution"));
...
bool VStudioPart::jumpedToItem( ItemDom item ) {
...
VStudioPart::~VStudioPart()
{
    ...
    delete (VSSlnExplorerWidget*) m_widget;
    delete m_hierarchyDlg;
}

void VStudioPart::slotProjectOpened( )
{
