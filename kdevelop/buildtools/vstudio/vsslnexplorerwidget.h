...
typedef class VSSlnExplorerWidget : public KListView, public QToolTip
{
  Q_OBJECT
public:
  enum ViewMode
...
} VSEWidget, *PVSEWidget;

class VSExplorerItem: public FancyListViewItem
{
private:
public:
  VSExplorerItem(QListView* parent, const QString& text=QString::null)
      : FancyListViewItem(static_cast<PVSEWidget>(parent)->m_paintStyles, parent, text) {
  }

  VSExplorerItem(QListViewItem* parent, const QString& text=QString::null)
...
//   virtual QString comment();
  ...
  VSSlnExplorerWidget* listView() {
    return static_cast<PVSEWidget>(QListViewItem::listView());
  }

  const VSSlnExplorerWidget* listView() const {
    return static_cast<PVSEWidget>(QListViewItem::listView());
  }
};
